...
<script>
    export default {
        ...
        mounted() {
            ...
            axios
            .get('http://127.0.0.1:8000/quizzesupdate/'+this.idquizz)
            .then(response => (
            ...
            axios
            .get('http://127.0.0.1:8000/quizzesquestionsupdate/'+this.idquizz)
            .then(response => (
        ...
        methods: {
            ...
            addQuiz(){
                axios.post(('http://127.0.0.1:8000/quizzes'), {filas:this.questions, datos:this.datos} )

                        ...
                        <form method="POST" id="regForm" enctype="multipart/form-data" action="{{ route('usuario.update', $usuarios->id) }}">
                            ...
                            <div class="tab"> Información Usuario:
                              <p>
                                ...
                                <input id="firstname" placeholder="Nombre" type="text" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" name="firstname" value="{{ $usuarios->firstname }}" required autofocus>
                              ...
                              <p>
                                ...
                                <input id="lastname" placeholder="Apellido" type="text" class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" name="lastname" value="{{ $usuarios->lastname }}" required autofocus>
                              ...
                              <p>
                                ...
                                <input id="email" placeholder="E-mail" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $usuarios->email }}" required>
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                              ...
                              <div id="app">
                                ...
                                {{-- <selectregisterupdate-component
                                    areaselected = "{{ $areas->id }}"
                                    positionselected = "{{ $positions->id }}">
                                </selectregisterupdate-component> --}}
                            ...
                            <div class="tab">Datos Personaje:
                              <p>
                                ...
                                <input id="username" placeholder="Nombre de Usuario" type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ $usuarios->username }}" required autofocus>
                            ...
                            <div class="tab anchus">
                              ...
                              <div class="container mainCont">
                                ...
                                <div class="col-sm txtPer filterDiv {{ $avatar->name }} {{ $avatar->sexo }}"> {{ $avatar->description }} </div>
                                @endforeach
                                
                                @foreach($avatars as $avatar)
                                  <div class="col-sm filterDiv {{ $avatar->name }} {{ $avatar->sexo }}">
                                      <img class="col-sm imgPer" src="{{ asset($avatar->img) }}" style="width: 70%" alt="">

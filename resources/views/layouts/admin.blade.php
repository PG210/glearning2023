            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li class="treeview">
               ...
               <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('usuario') }}"><i class="fa fa-circle-o text-aqua"></i> <span>Registro</span></a></li>
                    <li><a href="{{route('gruposvis')}}"><i class="fa fa-circle-o text-aqua"></i> <span>Grupos</span></a></li>
                </ul>
              </li>
              <!--END USUARIOS-->
              <li class="treeview">
